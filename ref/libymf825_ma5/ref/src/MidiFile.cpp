...
//////////////////////////////
//
// MidiFile::read (wstring version) -- Windows Unicode path support
//

bool MidiFile::read(const std::wstring& filename) {
	m_timemapvalid = 0;
	// Convert wide string to UTF-8 for setFilename
	...
	WideCharToMultiByte(CP_UTF8, 0, filename.c_str(), (int)filename.length(), &utf8_filename[0], size_needed, NULL, NULL);
	setFilename(utf8_filename);
	m_rwstatus = true;
...
//////////////////////////////
//
// MidiFile::readSmf (wstring version) -- Windows Unicode path support
//

bool MidiFile::readSmf(const std::wstring& filename) {
	m_timemapvalid = 0;
	// Convert wide string to UTF-8 for setFilename
	int size_needed = WideCharToMultiByte(CP_UTF8, 0, filename.c_str(), (int)filename.length(), NULL, 0, NULL, NULL);
	std::string utf8_filename(size_needed, 0);
